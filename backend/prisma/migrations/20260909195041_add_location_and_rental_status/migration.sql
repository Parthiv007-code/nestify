...
INSERT INTO "new_Listing" ("bathrooms", "bedrooms", "createdAt", "description", "id", "imageUrl", "location", "ownerId", "rent", "title") SELECT "bathrooms", "bedrooms", "createdAt", "description", "id", "imageUrl", "location", "ownerId", "rent", "title" FROM "Listing";
DROP TABLE "Listing";
